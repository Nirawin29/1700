...
class m700_RscControlsGroup {
    ...
    class VScrollBar : m700_RscScrollBar
    {
        width = 0.021;
        autoScrollEnabled = 1;
    };

    class HScrollBar : m700_RscScrollBar
    {
        height = 0.028;
    };
...
class m700_RscControlsGroupNoScrollbars : m700_RscControlsGroup {
...
class m700_RscListNBox
{
    ...
    autoScrollDelay = 5;
    autoScrollRewind = 0;
    class ListScrollBar: m700_RscScrollBar{};
    class ScrollBar: m700_RscScrollBar{};
};
...
class m700_RscTextBlack : m700_RscText {
    colorText[] = {0, 0, 0, 1};

};

class m700_RscLine: m700_RscText {
    idc = -1;
    style = 176;
    x = 0.17;
    y = 0.48;
...
class m700_RscTitle: m700_RscText {
    style = 0;
    sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
    colorText[] = {0.95, 0.95, 0.95, 1};
};

class m700_RscPicture {
    shadow = 0;
    type = 0;
    style = 48;
    sizeEx = 0.023;
...
class m700_RscTextMulti: m700_RscText
{
    linespacing = 1;
    style = 0 + 16 + 0x200;
};

class m700_RscPictureKeepAspect : m700_RscPicture
{
    style = 0x30 + 0x800;
};

class m700_RscStructuredText {
    type = 13;
    style = 0;
    x = 0;
    y = 0;
...
class m700_RscStructuredTextPrint : m700_RscStructuredText {
    style = 0x02 + 0x12;
};

class m700_RscActiveText {
idc = -1;
    type = 11;
    style = 0;
    x = 0;
...
class m700_RscButtonTextOnly : m700_RscButton {
    SizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
    colorBackground[] = {1, 1, 1, 0};
...
class m700_RscButtonMenu : m700_RscShortcutButton {
    idc = -1;
    type = 16;
    style = "0x02 + 0xC0";
    default = 0;
...
class m700_RscShortcutButtonMain : m700_RscShortcutButton {
    idc = -1;
    style = 0;
    default = 0;
    w = 0.313726;
...
class m700_RscListBoxBlack
{
    ...
    colorSelect[] = {0, 0, 0, 1};
    colorSelect2[] = {0, 0, 0, 1};
    colorSelectBackground[] = {0,0.37,0, 0.2};
    colorSelectBackground2[] = {0,0.37,0,0.4};
    colorScrollbar[] = {0.2, 0.2, 0.2, 1};
    colorPicture[] = {1,1,1,1};
    colorPictureSelected[] = {1,1,1,1};
    colorPictureDisabled[] = {1,1,1,1};
...
class m700_RscBackground: m700_RscText {
    type = 0;
    IDC = -1;
    style = 512;
    shadow = 0;
...
class m700_RscCombo {
    ...
    class ComboScrollBar : m700_RscScrollBar {};
};

class m700_RscToolbox {
    colorText[] = {0.95, 0.95, 0.95, 1};
    color[] = {0.95, 0.95, 0.95, 1};
...
class m700_RscButtonInvisible : m700_RscButtonMenu {
