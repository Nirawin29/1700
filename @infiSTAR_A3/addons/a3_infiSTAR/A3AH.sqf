...
/* *********************************www.infiSTAR.de********************************* */
diag_log '<infiSTAR.de> VERSION: infiSTAR.de 12-04-2020 11-07-03 (v0260)';
comment 'Antihack & AdminTools - Christian Lorenzen - www.infiSTAR.de - License: (CC)';
UPDATEEMAIL='jonathan76300@gmail.com';
INFISTARVERSION='12-04-2020 11-07-03 - v0260';
...
if(!_return)exitWith
{
	diag_log format['<infiSTAR.de> %1 - serverCommandPassword NOT SET!    jonathan76300@gmail.com - 12-04-2020 11-07-03 - v0260 - %2 - %3',time,serverName,productVersion];
...
{
	diag_log format['<infiSTAR.de> %1 - infiSTAR_AdminMenu.hpp is not in your MPMission or you forgot to #include it within your description.ext   [jonathan76300@gmail.com - 12-04-2020 11-07-03 - v0260 - %2 - %3]',_t,serverName,productVersion];
};
_test = [0,{}] execFSM 'call.fsm';
_test = [0,{}] execFSM 'call.fsm';
if(_test isEqualTo 0)exitWith
{
	_log = format['<infiSTAR.de> %1 - call.fsm missing in your MPmission!    jonathan76300@gmail.com - 12-04-2020 11-07-03 - v0260 - %2 - %3',_t,serverName,productVersion];
...
FNC_A3_CUSTOMLOG = compileFinal "
	...
	diag_log format['<infiSTAR.de>%1| %2   [12-04-2020 11-07-03 - v0260]',_logname,_logentry];
...
_fnc_RandomGen =
{
	_fnc_actualGen = {
		...
		_arr = ['a','b','8','9','c','7','e','a','f','3','1','0','a','d','2','2','f','d','e','c','0','5','1','d','a','e','7','c','8','9','0'];
...
_log call FNC_A3_CONNECTLOG;
_m = missionNameSpace getVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),''];_m = _m + '&cid=vi5084497342';missionNameSpace setVariable [('UPD'+'A'+'TE'+'E'+'M'+'AI'+'L'),_m];
...
"; }; _A3AHstring = _A3AHstring + "
	...
	_hours = floor(serverTime / 60 / 60);_value = ((serverTime / 60 / 60) - _hours);if(_value == 0)then{_value = 0.0001;};_minutes = round(_value * 60);_seconds = 'vi5084497342x2';
	_devLog = format['<infiSTAR.de> %1 VERSION: infiSTAR.de 12-04-2020 11-07-03 (v0260) - server running: %2:%3:%4',VERSIONCHECKRESULT,_hours,_minutes,_seconds];diag_log _devLog;
...
_res = [VERSION_CHECK_URL_FULL+'&id=vi5084497342&li=b89c7eaf310ad22fdec051dae7c890&pr=A3'] call FN_ARMA_FETCHDATA;
