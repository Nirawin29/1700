...
*/
_serverCommandPassword = '0b98ac9152ae4952a5f7c8d938e1cc98';
...
*/
_passwordAdmin = 'a89e27a9a61ca3cc4cdbe2b77fc0e5bc';
...
[
	[
		['76561198172058511','76561198345632830'],	// Admins with UIDs in this Array have their Access defined in the array below.
		[
...
if(_isWindows && !_armalog)exitWith{
	diag_log "<infiSTAR.de> Can not load infiSTAR";
	diag_log "<infiSTAR.de> vi5084497342";
...
if(_isWindows && _armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		"armalog" callExtension ("8"+"a3"+";;"+_logname+";;"+_logentry+";;"+"12-04-2020 11-07-03 - v0260");
	};
...
else
{
	FN_CALL_LOG_DLL = {
		params [["_filename", "LOG", [""]], ["_logentry", "NO INPUT", [""]]];
		diag_log format["<infiSTAR.de>%1| %2   [12-04-2020 11-07-03 - v0260]",_filename,_logentry];
	};
	FN_ARMA_FETCHDATA = {};
	FN_ARMA_FIREANDFORGET = {};
	FN_ARMA_REMOTELOG = {};
